...
void init_fire(void) {
    ...
    for (fireindex=0;fireindex<MAX_FIRE_TEXTURES;fireindex++) {
       ...
       glNewList(fire_id[fireindex], GL_COMPILE);
         ...
         static const GLfloat VertexData[] = {0.0,0.0,0.0,0.0,0.75,0.0,0.75,0.75,0.0,0.75,0.0,0.0};
         static const GLfloat VertexData1[] = {-0.08,0.62,-0.12,-0.08,0.75,-0.12,0.695,0.75,-0.12,0.695,0.62,-0.12};
         static const GLfloat VertexData2[] = {-0.0,0.52,-0.2,-0.0,0.68,-0.2,0.68,0.68,-0.2,0.68,0.52,-0.2};
